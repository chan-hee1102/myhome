...
> ${SITE.name}(${SITE.nameEn})은 생년·사는 곳·가족·집·소득 다섯 가지 답으로 청약·공공임대 공고의 신청 가능 여부와 예상 순위·가점을 계산하는 무료 서비스이며, 2026년 청약·공공임대 자격 기준을 법령 원문에 근거해 정리합니다.
...
## 도구
- [청약 자격 판정](${SITE.url}/check): 다섯 가지 질문으로 공고별 신청 가능·확인 필요·해당 없음 판정
