    ...
    <section id="faq" aria-labelledby="faq-title" className="scroll-mt-16 py-20 md:py-28">
      <div className="wrap grid gap-8 lg:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] lg:gap-16">
        <div>
          ...
          <h2 id="faq-title" className="t-display-l mt-3">
            자주 묻는 질문
          </h2>
          {SITE.sampleData && (
            <p className="t-small mt-6 max-w-[26em] rounded-[16px] bg-wash p-5 text-sub">
              지금은 <span className="font-semibold text-ink">예시 공고</span>로 결과를 보여 드리는 단계예요. 공식 API 수집을 연결하면 실제 공고로
              바뀌어요. 자격 기준표와 가이드는 실제 2026년 법령 기준이에요.
            </p>
          )}
        </div>
