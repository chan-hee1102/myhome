...
export const happyGuide: Guide = {
  ...
  description: `행복주택 청년은 만 19~39세 미혼 무주택자로 소득 100%(1인 가구 120%, 월 ${limitWon("happyYouth", 1)}) 이하, 총자산 ${manwon(A.happyYouth)} 이하면 신청할 수 있어요. 계층별 ${Y} 기준과 순위를 정리했어요.`,
  h1: `행복주택 자격 조건 (${Y}년 기준)`,
  answer: `행복주택 청년 계층은 만 19~39세 미혼 무주택자로, 소득이 도시근로자 월평균소득 100%(1인 가구 120%, ${Y}년 월 ${limitWon("happyYouth", 1)}) 이하이고 총자산 ${manwon(A.happyYouth)}·자동차 ${manwon(A.car)} 이하이면 신청할 수 있어요. 신혼부부 계층은 혼인 7년 이내(예비부부·한부모 포함)의 무주택 세대로 소득 100%(맞벌이 120%) 이하, 총자산 ${manwon(A.rentGeneral)} 이하가 기준이에요.`,
  ...
  sections: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "2순위: 같은 시·도(수도권은 수도권 전체)에 사는 사람",
            "3순위: 그 밖의 지역에 사는 사람",
            "같은 순위 안에서는 추첨으로 뽑아요. 젊은 계층(청년·대학생·신혼부부)에 80%, 고령자·주거급여 수급자에 20%를 공급해요.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "임대료는 주변 시세의 60~80% 수준이에요. 청년·대학생은 6년, 신혼부부는 6년(자녀가 있으면 10년), 고령자·주거급여 수급자는 20년까지 살 수 있어요. 세부 기간은 공고문에서 확인하세요.",
        },
      ],
    },
  ],
...
export const nationalGuide: Guide = {
  ...
  description: `국민임대는 무주택 세대가 소득 70%(전용 60㎡ 초과 100%, 1인 가구 +20%p) 이하, 총자산 ${manwon(A.rentGeneral)} 이하면 신청할 수 있어요. 면적별 순위와 동순위 배점표를 정리했어요.`,
  h1: `국민임대주택 자격 조건 (${Y}년 기준)`,
  answer: `국민임대주택은 세대원 모두 무주택이고 소득이 도시근로자 월평균소득 70%(전용 60㎡ 초과는 100%, 1인 가구 +20%p·2인 +10%p) 이하, 총자산 ${manwon(A.rentGeneral)}·자동차 ${manwon(A.car)} 이하이면 신청할 수 있어요. 전용 50㎡ 미만은 거주지, 50㎡ 이상은 청약통장 납입 횟수로 순위를 정해요.`,
  ...
  faq: [
    { q: "청약통장이 없어도 국민임대를 신청할 수 있나요?", a: "신청할 수 있어요. 다만 전용 50㎡ 이상은 통장 납입 횟수로 순위를 매기기 때문에 통장이 없으면 3순위가 돼요. 50㎡ 미만은 통장과 상관없이 거주지로 순위를 정해요." },
...
export const permanentGuide: Guide = {
  ...
  description: `영구임대는 기초생활수급자·한부모·장애인·국가유공자 등이 1순위, 소득 50%(1인 70%, 월 ${limitWon("permanentTier2", 1)}) 이하 무주택 세대가 2순위예요. ${Y} 기준과 선정 절차를 정리했어요.`,
  h1: `영구임대주택 신청 자격 (${Y}년 기준)`,
  answer: `영구임대주택은 기초생활수급자·한부모가족·장애인·국가유공자 등 주거취약계층이 1순위, 소득이 도시근로자 월평균소득 50%(1인 가구 70%, ${Y}년 월 ${limitWon("permanentTier2", 1)}) 이하인 무주택 세대가 2순위예요. 순위를 정한 뒤 지자체가 입주자를 선정해요.`,
  ...
  sections: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            `자산: 총자산 ${manwon(A.permanent)}·자동차 ${manwon(A.car)} 이하 — 총자산 값은 신청 전에 공고문 숫자로 한 번 더 확인하세요`,
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "주민등록지 읍·면·동 주민센터에 신청하면, 지자체가 자격을 확인해 순위와 배점을 매기고 공급기관(LH·지방공사)에 명단을 넘겨요. 대기자로 등록된 뒤 빈집이 생기는 순서대로 입주해요. 세부 배점은 지역·공고마다 달라요.",
        },
      ],
    },
  ],
...
export const integratedGuide: Guide = {
  ...
  description: `통합공공임대는 기준 중위소득 150%(1인 170%, 월 ${limitWon("integrated", 1)}) 이하 무주택 세대가 신청할 수 있어요. 청년·신혼부부 기준과 우선공급 배점표를 정리했어요.`,
  h1: `통합공공임대주택 자격 (${Y}년 기준)`,
  answer: `통합공공임대주택은 세대원 모두 무주택이고 소득이 기준 중위소득 150%(1인 가구 170%, ${Y}년 월 ${limitWon("integrated", 1)}·2인 160%) 이하, 총자산 ${manwon(A.rentGeneral)}·자동차 ${manwon(A.car)} 이하이면 신청할 수 있어요. 신혼부부 맞벌이는 180%, 청년 계층은 만 18~39세 미혼으로 본인만 무주택이면 돼요.`,
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "일반공급: 2세 미만 자녀가 있는 가구에 5%를 먼저 배정하고, 나머지는 소득 구간별로 나눠 추첨해요(중위소득 50% 이하 45%, 50~100% 30%, 100% 초과 15% 이상).",
          ],
        },
        {
          t: "table",
          table: {
            ...
            note: "단독세대주는 부양가족·자녀 항목을 적용하지 않아요. 과거 공공임대 계약 이력이 있으면 감점돼요(1년 이내 -5점, 3년 이내 -3점).",
          },
        },
      ],
    },
  ...
  faq: [
    { q: "통합공공임대는 왜 도시근로자 소득이 아니라 중위소득을 쓰나요?", a: "영구·국민·행복주택을 하나로 합친 새 유형이라, 복지 제도와 같은 기준 중위소득으로 대상을 넓게 잡았어요. 같은 소득이라도 행복주택보다 기준 %가 높게 보이는 이유예요." },
  ],
  sources: [SRC.publicRule, SRC.myhomeGuide],
...
export const purchaseGuide: Guide = {
  ...
  description: `매입임대 청년은 만 19~39세 미혼 무주택자로 수급자 등 1순위, 본인+부모 소득 100% 2순위, 본인 소득 100% 3순위예요. 신혼·신생아 Ⅰ형은 소득 70%(맞벌이 90%)가 기준이에요.`,
  h1: `매입임대주택 자격 (${Y}년 기준)`,
  answer: `청년 매입임대는 만 19~39세 미혼 무주택자(대학생·취업준비생 포함)가 신청하고, 수급자·차상위·한부모가 1순위, 본인과 부모 소득이 100% 이하면 2순위, 본인 소득만 100% 이하(총자산 ${manwon(A.happyYouth)} 이하)면 3순위예요. 신혼·신생아 Ⅰ형은 무주택 세대로 소득 70%(맞벌이 90%) 이하가 기준이에요.`,
  ...
  sections: [
      ...
      blocks: [
        ...
        },
        {
          ...
          items: [
            ...
            "Ⅱ형은 소득 100%(맞벌이 120%) 이하까지 넓어지고, 임대료가 더 높아요.",
          ],
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "LH·지방공사가 도심의 다가구·다세대·오피스텔 등을 사들여 시세보다 낮은 임대료로 빌려주는 집이에요. 청약통장 없이 신청할 수 있어요. 임대료 수준과 거주 기간은 계층·유형마다 달라서 공고문에서 확인해야 해요.",
        },
      ],
    },
  ],
  faq: [
    { q: "대학생도 청년 매입임대를 신청할 수 있나요?", a: "네. 대학생·취업준비생도 청년 계층으로 신청할 수 있어요. 부모님 소득까지 기준 안쪽이면 2순위가 돼요." },
  ],
  sources: [SRC.publicRule, SRC.myhomeGuide],
...
export const jeonseGuide: Guide = {
  ...
  description: `전세임대는 직접 구한 전셋집을 LH가 계약해 다시 빌려주는 방식이에요. 신혼·신생아 Ⅱ형은 소득 130%(맞벌이 200%)·총자산 ${manwon(A.newhome)} 이하, 청년은 매입임대와 같은 순위를 써요.`,
  h1: `전세임대주택 자격 (${Y}년 기준)`,
  answer: `전세임대는 입주자가 직접 고른 전셋집을 LH가 집주인과 계약한 뒤 싸게 다시 빌려주는 공공임대예요. 신혼·신생아 Ⅱ형은 무주택 세대로 소득 130%(맞벌이 200%) 이하·총자산 ${manwon(A.newhome)} 이하이면 신청할 수 있고, 청년은 매입임대와 같은 1~3순위 기준을 써요.`,
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "LH가 집주인과 전세계약을 맺고, 입주자는 보증금 일부와 LH 지원금 이자 수준의 월 임대료를 내요.",
  ...
  faq: [
    { q: "전세임대 집은 아무 집이나 고를 수 있나요?", a: "지원 한도 안의 보증금이고, 주택 유형·면적·부채 비율 같은 LH 기준을 통과한 집이어야 해요. 집주인도 LH와의 계약에 동의해야 해요." },
  ],
  sources: [SRC.publicRule, SRC.myhomeGuide],
...
export const youthSafeGuide: Guide = {
  ...
  description: `서울 청년안심주택 청년형은 만 19~39세 미혼 무주택자로, 특별공급은 소득 120%(1인 월 ${limitWon("youthSafe", 1)}) 이하·본인 자산 ${manwon(A.happyYouth)} 이하가 기준이에요. 소득을 넘으면 일반공급으로 신청해요.`,
  h1: `서울 청년안심주택 자격 (${Y}년 기준)`,
  answer: `서울 청년안심주택 청년형은 만 19~39세 미혼이고 본인이 무주택이면 신청할 수 있고, 특별공급은 소득이 도시근로자 월평균소득 120%(1인 가구 ${Y}년 월 ${limitWon("youthSafe", 1)}) 이하이고 본인 자산이 ${manwon(A.happyYouth)} 이하여야 해요. 소득 기준을 넘으면 일반공급(추첨)으로만 신청할 수 있어요.`,
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "민간이 짓고 서울시가 지원하는 공공지원민간임대로, 지하철역 가까이에 들어서요. 모집공고는 서울시 청년안심주택 누리집에 올라오고, 공공임대분(SH 공급)과 민간임대분은 순위·임대료가 달라요.",
        },
      ],
    },
  ],
  faq: [
    { q: "소득 기준을 넘으면 청년안심주택을 신청할 수 없나요?", a: "특별공급은 소득 120% 이하만 신청할 수 있지만, 소득 기준을 넘어도 일반공급으로는 신청할 수 있어요. 일반공급은 추첨으로 뽑아요." },
  ],
...
export const deundeunGuide: Guide = {
  ...
  description: "HUG 든든전세주택은 무주택 세대구성원이면 소득·자산과 상관없이 신청할 수 있고, 무작위 추첨으로 입주자를 뽑아요. 신청 자격과 절차를 정리했어요.",
  h1: "HUG 든든전세주택 신청 자격",
  answer: "HUG 든든전세주택은 세대원 모두 무주택이면 소득·자산 기준 없이 신청할 수 있고, 신청자 가운데 무작위 추첨으로 입주자를 뽑아요. 주택도시보증공사가 확보한 주택을 시세보다 낮은 전세보증금으로 빌려주고, 차수마다 우선공급 대상과 조건이 달라질 수 있어요.",
  ...
  sections: [
      ...
      blocks: [
        {
          t: "ul",
          items: [
            "신청자와 세대원 모두 무주택이어야 해요(신청자·배우자의 직계혈족 기준으로 확인).",
            "소득·자산·나이·혼인 기준이 없어요.",
            "청약통장이 없어도 돼요.",
          ],
        },
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "주택도시보증공사(HUG) 누리집에 차수별로 공고가 올라와요. 접수 기간이 짧고, 마감되면 공고 목록에서 내려가요. 보증금 수준과 거주 기간, 우선공급 대상은 차수별 공고문에서 확인하세요.",
        },
      ],
    },
  ],
  faq: [{ q: "든든전세도 청약통장이 있어야 하나요?", a: "필요 없어요. 세대원 모두 무주택이면 통장·소득·자산과 상관없이 신청할 수 있어요. 중복 신청이 되는지 같은 세부 규정은 차수별 공고문을 확인하세요." }],
...
export const publicSaleGuide: Guide = {
  ...
  description: `공공분양(뉴홈 일반형) 전용 60㎡ 이하는 무주택 세대로 소득 100%(3인 이하 월 ${won(STD.incomeSaleUpTo3)}, 맞벌이 140%)·부동산 ${manwon(A.publicSaleSmall)} 이하가 기준이에요. 1순위와 순차제 선정 방식을 정리했어요.`,
  h1: `공공분양 자격 조건 (${Y}년 기준)`,
  answer: `공공분양(국민주택) 전용 60㎡ 이하 일반공급은 세대원 모두 무주택이고 소득이 3인 이하 가구 기준 ${Y}년 월 ${won(STD.incomeSaleUpTo3)}(100%, 맞벌이 140%) 이하, 부동산 ${manwon(A.publicSaleSmall)}·자동차 ${manwon(A.car)} 이하이면 신청할 수 있어요. 60㎡ 초과는 소득·자산 기준이 없고, 1순위 안에서는 저축 총액이나 납입 횟수가 많은 순으로 뽑아요.`,
  ...
  sections: [
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "30%는 순차제예요. 3년 이상 무주택 세대 중 저축 총액(전용 40㎡ 초과, 월 25만 원까지 인정)이나 납입 횟수(40㎡ 이하)가 많은 순으로 뽑아요.",
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "수도권은 가입 12개월·12회 납입, 그 밖의 지역은 6개월·6회를 채우면 돼요. 투기과열지구·청약과열지역은 24개월·24회에 더해 세대주이면서 5년 안에 세대원 모두 당첨된 적이 없어야 해요. 자세한 요건은 1순위 조건(/guide/first-rank) 가이드에 정리했어요.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: `나눔형은 시세의 70% 이하로 분양하고, 되팔 때 이익을 공공과 나누는 방식이에요. 일반공급 20%를 같은 50/30/추첨 구조로 뽑고, 소득은 100%(추첨분 맞벌이 200%), 자산은 총자산 ${manwon(A.newhome)} 이하예요. 선택형은 6년 동안 임대로 살아 본 뒤 분양받을지 고르는 방식이고, 가구원수별 금액을 써요.`,
        },
      ],
    },
  ],
...
export const privateAptGuide: Guide = {
  ...
  description: "민영 아파트 일반공급은 소득·자산 기준 없이 청약통장 가입기간과 예치금으로 1순위를 정하고, 1순위 안에서는 가점제와 추첨제로 뽑아요. 조건과 선정 방식을 정리했어요.",
  h1: `민영 아파트 청약 조건 (${Y}년 기준)`,
  answer: "민영 아파트 일반공급은 소득·자산 기준이 없고, 청약통장 가입기간(규제지역 24개월·수도권 12개월·그 외 6개월)과 지역·면적별 예치금을 채우면 1순위예요. 1순위 안에서는 전용면적과 규제지역에 따라 일부를 가점 84점 순으로, 나머지를 추첨으로 뽑아요.",
      ...
      blocks: [
        {
          t: "ul",
          items: [
            "만 19세 이상이고 청약통장이 있으면 누구나 신청할 수 있어요(집이 있어도 가능, 규제지역은 제한).",
            "1순위: 가입기간과 예치금을 채운 사람이에요. 규제지역은 세대주·5년 내 당첨 없음·2주택 이상 세대 아님이 더 붙어요.",
  ...
  faq: [
    { q: "집이 있어도 민영 아파트 청약을 할 수 있나요?", a: "비규제지역에서는 할 수 있어요. 다만 가점제 물량은 무주택자 중심이에요. 규제지역 1순위는 2주택 이상 세대가 될 수 없고, 추첨 물량도 무주택자에게 먼저 배정해요." },
  ],
