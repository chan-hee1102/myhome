...
export const GUIDE_HUB = {
  ...
  description:
    "행복주택, 국민임대, 공공분양, 민영 아파트 등 10개 유형의 2026년 자격 기준이에요. 유형마다 나이, 소득, 자산, 청약통장 기준과 특별공급 조건을 표로 볼 수 있어요. 가점 계산기도 함께 있어요.",
  answer:
    "청약·공공임대 자격은 무주택 여부, 소득, 자산, 청약통장 네 가지로 정해져요. 소득은 도시근로자 월평균소득이나 기준 중위소득의 몇 %인지로 보고, 그 비율은 유형과 공급 대상마다 달라요. 2026년 새 기준은 소득이 1월 1일, 자산이 2월 27일 이후 모집공고부터 적용돼요.",
  updated: UPDATED,
};
