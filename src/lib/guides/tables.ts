...
export const incomeGuide: Guide = {
  ...
  description: `${Y}년 도시근로자 월평균소득 100%는 1인 가구 ${won(STD.incomeByHousehold[1])}, 3인 가구 ${won(STD.incomeByHousehold[3])}이에요. 비율별 금액과 기준 중위소득, 청약·공공임대 유형마다 쓰는 비율을 표로 볼 수 있어요.`,
  h1: `${Y}년 도시근로자 월평균소득·기준 중위소득 표`,
  answer: `${Y}년 도시근로자 월평균소득 100%는 1인 가구 ${won(STD.incomeByHousehold[1])}, 2인 가구 ${won(STD.incomeByHousehold[2])}이에요. 3인 가구는 ${won(STD.incomeByHousehold[3])}, 4인 가구는 ${won(STD.incomeByHousehold[4])}이고, ${Y}년 1월 1일 이후 모집공고부터 적용돼요. 공공분양과 특별공급은 3인 이하 가구에 같은 금액(${won(STD.incomeSaleUpTo3)})을 쓰고, 통합공공임대는 기준 중위소득을 봐요.`,
  ...
  sections: [
    {
      ...
      blocks: [
        {
          t: "p",
          text: "행복주택, 국민임대, 영구임대, 매입임대, 전세임대 같은 공공임대와 청년안심주택은 아래 금액을 써요. 가구원수별 금액에 공고에 적힌 비율을 곱하면 소득 상한이 나와요. 표의 금액은 모두 세전 월소득이에요.",
        },
        {
          t: "table",
          table: {
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: `공공분양 일반공급과 신혼부부, 생애최초, 신생아 특별공급은 1~3인 가구에 금액 하나를 똑같이 써요. 3인 이하 가구당 월평균소득인 ${won(STD.incomeSaleUpTo3)}이에요. 4인 가구부터는 가구원수별 금액을 봐요. 그래서 1인·2인 가구는 임대 계열보다 기준이 넉넉해요.`,
        },
        {
          t: "table",
          table: {
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: `통합공공임대는 도시근로자 소득이 아니라 보건복지부가 고시하는 기준 중위소득을 써요. 일반 기준은 150%예요. 1인 가구는 170%, 2인 가구는 160%까지 넓어져요. ${Y}년 1인 가구 170%는 월 ${limitWon("integrated", 1)}이에요.`,
        },
        {
          t: "table",
          table: {
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "1인 가구 +20%p, 2인 가구 +10%p 가산은 임대 계열에만 붙어요. 행복주택, 국민임대, 영구임대, 매입임대, 전세임대가 여기에 들어가요. 공공분양 일반형과 민영주택 특별공급에는 붙지 않아요. 예를 들어 행복주택 청년 계층은 기준이 100%지만, 1인 가구는 120%가 적용돼요. " +
            `그래서 상한은 월 ${limitWon("happyYouth", 1)}이에요.`,
        },
        {
          t: "p",
      ...
      blocks: [
        {
          t: "ul",
          items: [
            "세전 금액이에요. 근로소득, 사업소득, 재산소득 등을 합친 월평균으로 봐요.",
            "청년 계층처럼 본인 소득만 보는 유형을 빼면, 같은 주민등록에 있는 세대원 소득을 모두 더해요.",
            "가구원수에는 태아도 넣어요. 직계존속은 일정 기간 같은 주민등록에 있어야 넣는데, 그 기간은 유형마다 달라요.",
  ...
  faq: [
    {
      ...
      a: `${won(STD.incomeByHousehold[1])}이에요. 임대 계열은 1인 가구에 20%p를 더해요. 그래서 100%를 기준으로 쓰는 유형이면 실제 상한은 120%인 ${limitWon("happyYouth", 1)}이에요.`,
    },
    {
      q: `소득 기준은 언제부터 ${Y}년 값으로 바뀌나요?`,
      a: `${Y}년 1월 1일 이후 입주자 모집공고를 낸 단지부터 ${Y}년 값을 써요. 그 전 공고는 전년도 값이 그대로 적용돼요. 자산 기준은 적용일이 ${Y}년 2월 27일로 달라요.`,
    },
    {
      q: "맞벌이 가구는 기준이 얼마나 넓어지나요?",
      a: "유형마다 달라요. 행복주택 신혼부부는 120%, 공공분양 특별공급은 200%, 민영 신혼부부 특별공급은 160%예요. 부부 중 한 사람의 소득이 일정 비율을 넘으면 맞벌이 기준을 못 쓰는 경우도 있어요. 공고문에서 함께 확인하세요.",
    },
  ],
  ...
  dataset: {
    ...
    description: `${Y}년 1월 1일 이후 모집공고에 적용되는 도시근로자 가구원수별 월평균소득 표예요. 비율별 금액과 분양 계열 3인 이하 가구당 금액, 기준 중위소득도 담았어요.`,
    anchor: "rent",
...
export const assetsGuide: Guide = {
  ...
  description: `${Y}년 국민임대, 통합공공임대, 행복주택 신혼부부·고령자의 총자산 상한은 ${manwon(A.rentGeneral)}이에요. 행복주택 청년은 ${manwon(A.happyYouth)}, 자동차는 ${manwon(A.car)}, 공공분양은 부동산 ${manwon(A.publicSaleSmall)}까지예요.`,
  h1: `${Y}년 자산·자동차 기준 (공공임대·공공분양)`,
  answer: `${Y}년 2월 27일 이후 모집공고부터 국민임대, 통합공공임대, 행복주택 신혼부부·고령자의 총자산 상한은 ${manwon(A.rentGeneral)}이에요. 행복주택 청년은 ${manwon(A.happyYouth)}, 대학생은 ${manwon(A.happyStudent)}까지예요. 자동차는 ${manwon(A.car)} 이하여야 해요. 공공분양 전용 60㎡ 이하는 총자산 대신 부동산이 ${manwon(A.publicSaleSmall)} 이하인지만 봐요.`,
  facts: [`총자산 ${manwon(A.rentGeneral)}`, `청년 ${manwon(A.happyYouth)}`, `자동차 ${manwon(A.car)}`],
  pending: "영구임대, 매입임대, 전세임대 일반의 총자산 기준은 고시 원문과 한 번 더 맞춰 보는 중이에요. 민영 특별공급 추첨분의 부동산 기준도 마찬가지예요. 신청 전에 공고문 숫자를 꼭 확인하세요.",
  sections: [
    {
      id: "limits",
      h2: `${Y}년 유형별 자산 상한`,
    ...
    },
    {
      ...
      blocks: [
        ...
        {
          t: "p",
          text: "공공분양 전용 60㎡ 이하와 민영 특별공급 추첨분은 토지와 건물 같은 부동산만 봐요. 그래서 예금이 많아 총자산이 기준을 넘어도, 부동산이 기준 이하면 신청할 수 있어요.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: `${Y}년 자산 기준은 ${Y}년 2월 27일 이후 모집공고부터 적용돼요. 소득 기준은 1월 1일부터라 적용일이 달라요. 그래서 1~2월 공고는 소득만 새 값이고, 자산은 전년도 값일 수 있어요.`,
        },
      ],
    },
  ],
  faq: [
    {
      ...
      a: `행복주택 청년과 청년안심주택 청년형은 본인 자산만 봐요. 기준은 ${manwon(A.happyYouth)} 이하예요. 뉴홈 나눔형 청년 특별공급처럼 부모 자산까지 보는 유형도 있어요. 이때 부모 자산은 10억 3,500만 원 이하여야 해요.`,
    },
    {
    ...
    {
      q: "든든전세도 자산을 보나요?",
      a: "HUG 든든전세는 소득·자산 기준이 없어요. 세대 구성원이 모두 무주택이면 신청할 수 있어요. 입주자는 추첨으로 뽑아요.",
    },
  ],
...
export const depositGuide: Guide = {
  ...
  description: `민영주택 1순위 예치금은 전용 85㎡ 이하 기준으로 서울·부산 ${DEP.seoulBusan["85"]}만 원, 광역시 ${DEP.metro["85"]}만 원, 그 밖의 지역 ${DEP.other["85"]}만 원이에요. 내 예치금으로 넣을 수 있는 최대 면적도 표로 볼 수 있어요.`,
  h1: "청약 예치금 기준표 (지역·전용면적별)",
  answer: `민영주택 예치금은 신청자의 주민등록 거주지와 신청할 주택의 전용면적으로 정해져요. 서울·부산은 85㎡ 이하 ${DEP.seoulBusan["85"]}만 원, 102㎡ 이하 ${DEP.seoulBusan["102"]}만 원, 135㎡ 이하 ${DEP.seoulBusan["135"]}만 원, 모든 면적 ${DEP.seoulBusan.all.toLocaleString("ko-KR")}만 원이에요. 입주자 모집공고일까지 이 금액 이상이 통장에 들어 있어야 1순위가 돼요.`,
      ...
      blocks: [
        {
          ...
          items: [
            ...
            "예치금은 민영주택 기준이에요. 공공분양(국민주택)은 예치금이 아니라 납입 횟수와 저축 총액으로 봐요.",
  ...
  faq: [
    ...
    {
      q: "인천에 살면 예치금이 얼마인가요?",
      a: `인천은 기타 광역시 기준을 써요. 85㎡ 이하 ${DEP.metro["85"]}만 원, 102㎡ 이하 ${DEP.metro["102"]}만 원, 135㎡ 이하 ${DEP.metro["135"]}만 원, 모든 면적 ${DEP.metro.all.toLocaleString("ko-KR")}만 원이에요.`,
    },
    {
      q: "공공분양도 예치금을 보나요?",
      a: "보지 않아요. 공공분양(국민주택)은 가입 기간과 납입 횟수로 1순위를 정해요. 같은 순위 안에서는 저축 총액이나 납입 횟수가 많은 사람부터 뽑아요.",
    },
  ],
...
export const gajeomGuide: Guide = {
  ...
  description:
    "민영주택 청약 가점은 무주택기간 32점, 부양가족 35점, 청약통장 17점을 더한 84점 만점이에요. 가점 계산기로 내 점수를 바로 계산해 볼 수 있어요. 무주택기간을 만 30세부터 따지는 규칙과 배우자 통장 합산(최대 3점), 전체 점수표도 함께 있어요.",
  h1: "청약 가점 계산기 (84점 만점 점수표)",
  answer:
    "민영주택 청약 가점은 무주택기간(최대 32점), 부양가족 수(최대 35점), 청약통장 가입기간(최대 17점)을 더한 84점 만점이에요. 무주택기간은 만 30세부터 따지고, 그 전에 혼인했다면 혼인신고일부터예요. 만 30세 전 미혼 무주택자와 집이 있는 사람은 무주택기간 점수가 0점이에요.",
  ...
  sections: [
    { id: "calculator", h2: "내 청약 가점은 몇 점인가요?", blocks: [{ t: "calc" }] },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "신청자와 배우자가 계속 무주택인 기간을 따져요. 시작일은 만 30세가 된 날이고, 만 30세 전에 결혼했다면 혼인신고일이에요. 집을 처분했다면 가장 최근에 무주택이 된 날부터 따져요.",
        },
        {
          t: "table",
      ...
      blocks: [
        {
          t: "ul",
          items: [
            "배우자: 세대를 나눠 사는 배우자도 넣어요.",
            "본인과 배우자의 직계존속: 3년 이상 같은 주민등록에 올라 있어야 해요. 집이 있으면 빠져요.",
            "미혼 자녀: 만 30세 이상이면 1년 이상 같은 주민등록에 올라 있어야 해요.",
            "신청자 본인은 부양가족 수에 넣지 않아요.",
          ],
        },
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "2024년 3월 25일부터 배우자의 청약통장 가입기간도 점수에 더할 수 있어요. 배우자 점수의 50%를 최대 3점까지 더해요. 본인 점수와 합쳐도 17점을 넘지 않아요. 미성년자 때 가입한 기간은 최대 5년까지 인정해요. 개정 전 기간은 2년까지만 쳐요.",
        },
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "1순위 안에서 경쟁이 생기면 전용면적과 규제지역 여부에 따라 일부는 가점 순으로, 나머지는 추첨으로 뽑아요. 가점이 같으면 가입기간이 긴 사람이 먼저예요. 그래도 같으면 추첨해요.",
        },
        {
          t: "table",
          table: {
  ...
  faq: [
    ...
    { q: "부모님과 같이 살면 부양가족으로 셀 수 있나요?", a: "부모님이 3년 이상 계속 같은 주민등록에 올라 있고 집이 없으면 부양가족으로 넣어요. 부모님 중 한 분이라도 집이 있으면 그분은 부양가족에서 빠져요." },
    { q: "공공분양도 가점으로 뽑나요?", a: "아니요. 공공분양(국민주택) 일반공급은 가점제가 아니라 순차제로 뽑아요. 전용 40㎡ 초과는 저축 총액이 많은 순이고, 월 25만 원까지만 인정해요. 40㎡ 이하는 납입 횟수가 많은 순이에요." },
  ],
...
export const firstRankGuide: Guide = {
  ...
  description:
    "청약 1순위는 통장 가입기간과 예치금 또는 납입 횟수로 정해져요. 가입기간은 규제지역 24개월, 수도권 12개월, 그 외 지역 6개월이에요. 규제지역에서는 요건이 더 붙어요.",
  h1: "청약 1순위 조건 (민영주택·국민주택)",
  answer:
    "청약 1순위가 되려면 먼저 통장 가입기간을 채워야 해요. 투기과열지구·청약과열지역은 24개월, 수도권은 12개월, 그 밖의 지역은 6개월이에요. 여기에 민영주택은 지역·면적별 예치금을, 국민주택은 가입 개월 수와 같은 횟수의 납입을 채우면 돼요. 규제지역에서는 세대주여야 하고, 5년 안에 세대원 모두 당첨된 적이 없어야 해요. 민영주택은 2주택 이상 세대도 1순위가 될 수 없어요.",
  ...
  sections: [
    ...
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "규제지역은 국토교통부가 지정하고 해제해서 자주 바뀌어요. 2025년 10월 15일 발표로 서울 25개 구 전체와 경기 12개 시·구가 투기과열지구·조정대상지역이 됐어요. 단지가 규제지역인지는 입주자 모집공고문 첫머리에 적혀 있어요. 신청 전에 꼭 확인하세요.",
        },
      ],
    },
    {
      ...
      blocks: [
        {
          t: "p",
          text: "1순위 조건을 채우지 못해도 청약통장이 있으면 2순위로 신청해요. 다만 1순위에서 공급 물량이 다 차면 2순위 차례는 오지 않아요. 2순위 안에서는 추첨으로 뽑아요.",
        },
      ],
    },
  ],
